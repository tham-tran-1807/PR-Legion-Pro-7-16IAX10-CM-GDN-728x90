...
lib.ssMetadata = [
		{name:"PR_Legion_Pro_7_16IAX10_CM_GDN_728x90_atlas_1", frames: [[730,0,50,50],[0,0,728,90],[0,92,728,90],[0,184,728,90],[0,276,728,90],[0,368,728,90],[0,460,728,90],[0,552,728,90]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["PR_Legion_Pro_7_16IAX10_CM_GDN_728x90_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.PRLegionPro716IAX10CMGDN728x90 = function(mode,startPosition,loop,reversed) {
...
// library properties:
lib.properties = {
	id: '1924B3BF6F139E4D8BEA578FB461B04B',
	width: 728,
	height: 90,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PR_Legion_Pro_7_16IAX10_CM_GDN_728x90_atlas_1.png", id:"PR_Legion_Pro_7_16IAX10_CM_GDN_728x90_atlas_1"}
	],
	preloads: []
};
...
an.compositions['1924B3BF6F139E4D8BEA578FB461B04B'] = {
